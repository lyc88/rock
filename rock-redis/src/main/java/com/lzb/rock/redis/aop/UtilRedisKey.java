...
public class UtilRedisKey {
	 ...
	 * @return
	 */
	protected static String getKey(String constant, String[] names, Object[] params, String[] parameters) {
	 ...
	 * @return
	 */
	protected static String getKey(String constant, Object[] params) {
		StringBuffer sb = new StringBuffer();
		if(constant.endsWith("_")) {
			sb.append(constant);
		}else {
		...
		for (Object parameter : params) {
			sb.append(JSONObject.toJSONString(parameter)).append("_");
		}
		return sb.substring(0, sb.length()-1);
	}
	/**
	 ...
	 * @return
	 */
	protected static String getParam(String[] names, Object[] params, String parameter) {
		String param = null;
