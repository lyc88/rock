...
import com.lzb.rock.base.util.UtilCalculationDate;
...
public class UtilCalendar {
	...
	private static Date SolarFromInt(long g) {
		...
		String str  = solar.getSolarYear()+"-"+solar.getSolarMonth()+"-"+solar.getSolarDay() +" 00:00:00";
		
		return UtilCalculationDate.StrToDate(str) ;
	}
